...
export const setInitialPosition = (state, payload) =>
  state
    .setIn([STATE_GEO_INITIAL_POSITION, STATE_GEO_LATITUDE], payload.latitude)
    .setIn(
      [STATE_GEO_INITIAL_POSITION, STATE_GEO_LONGITUDE],
      payload.longitude
    );
